...
export default function Footer() {
  ...
  return (
    <>
      <div className={` ${theme === 'light' ? 'bg-white text-black' : 'bg-black text-white'} bg-white text-gray-600 pt-12  shadow-xl w-full absolute left-0  right-0 bottom-0 py-8 mt-4 font-semibold h-[220px] `}>
