...
export default function Footer() {
  ...
  return (
    <>
      <div className={` footer ${theme === 'light' ? 'bg-white text-black' : 'bg-black text-black'} bg-white text-gray-600 pt-12 mt-14  shadow-xl w-full absolute left-0  right-0 bottom-0 py-8 font-semibold sm:mt-16 h-[220px] sm:h-fit `}>
